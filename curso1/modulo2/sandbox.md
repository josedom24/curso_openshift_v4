...
* La cuota de recurso que podemos usar en nuestro proyecto es de 7 GB RAM, y 15 GB de almacenamiento.
...
* Al usar un usuario sin privilegios, no tendremos acceso algunos recursos: la gestión de proyectos, los nodos del clúster, los volúmenes de almacenamiento,...
